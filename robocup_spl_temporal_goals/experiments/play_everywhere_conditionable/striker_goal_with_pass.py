...
def get_problem_name():
    return "fond_planning_striker_goal_with_pass_constrainable"
...
def role_to_generation_data():
    ...
    return {
        "striker" : {
            "goal" : "O(isat_robot1_ballposition) && O(goalscored) && (ballsafe S goalscored)",
            "pddl_domain_path" : os.path.join(currentdir, "PDDL", "striker_domain_fond.pddl"),
            "pddl_problem_path" : os.path.join(currentdir, "PDDL", "striker_goal_with_pass_problem_fond.pddl"),
