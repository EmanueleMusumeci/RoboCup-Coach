...
def get_problem_name():
    return "fond_planning_striker_no_goal_conditionable"
...
def role_to_generation_data():
    ...
    return {
        "striker" : {
            "goal" : "O(isat_robot1_ballposition)",
            "pddl_domain_path" : os.path.join(currentdir, "PDDL", "striker_domain_fond.pddl"),
            "pddl_problem_path" : os.path.join(currentdir, "PDDL", "striker_no_goal_problem_fond.pddl"),
