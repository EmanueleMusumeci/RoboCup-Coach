(define (domain robocupdeterministic)
    ...
    (:predicates (Oisat_robot_wpc2r2) (adjacent ?loc1 ?loc2) (isat ?mov ?loc) (isball ?mov) (isrobot ?mov) (val_Oisat_robot_wpc2r2) (val_isat_ball_wpc3r2) (val_isat_ball_wpc3r2-and-Oisat_robot_wpc2r2) (val_isat_robot_wpc2r2))
    (:derived (val_Oisat_robot_wpc2r2) (or (val_isat_robot_wpc2r2) (Oisat_robot_wpc2r2)))
     (:derived (val_isat_ball_wpc3r2) (isat ball wpc3r2))
     (:derived (val_isat_ball_wpc3r2-and-Oisat_robot_wpc2r2) (and (val_isat_ball_wpc3r2) (val_Oisat_robot_wpc2r2)))
