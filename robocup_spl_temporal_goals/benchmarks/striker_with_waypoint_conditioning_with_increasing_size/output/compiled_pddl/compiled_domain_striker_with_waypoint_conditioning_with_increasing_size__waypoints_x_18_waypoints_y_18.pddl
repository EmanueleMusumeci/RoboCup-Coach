(define (domain robocupdeterministic)
    ...
    (:predicates (Oisat_robot_wpc9r9) (adjacent ?loc1 ?loc2) (isat ?mov ?loc) (isball ?mov) (isrobot ?mov) (val_Oisat_robot_wpc9r9) (val_isat_ball_wpc17r9) (val_isat_ball_wpc17r9-and-Oisat_robot_wpc9r9) (val_isat_robot_wpc9r9))
    (:derived (val_Oisat_robot_wpc9r9) (or (val_isat_robot_wpc9r9) (Oisat_robot_wpc9r9)))
     ...
     (:derived (val_isat_ball_wpc17r9-and-Oisat_robot_wpc9r9) (and (val_isat_ball_wpc17r9) (val_Oisat_robot_wpc9r9)))
