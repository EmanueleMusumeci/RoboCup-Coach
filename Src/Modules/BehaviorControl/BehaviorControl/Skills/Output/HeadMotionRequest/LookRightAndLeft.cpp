/**
 * @file LookRightAndLeft.cpp
 *
 * This file implements the implementation of the LookRightAndLeft skill.
 *
...
SKILL_IMPLEMENTATION(LookRightAndLeftImpl,
{,
  IMPLEMENTS(LookRightAndLeft),
...
class LookRightAndLeftImpl : public LookRightAndLeftImplBase
{
  ...
  void setRequest(const LookRightAndLeft& p, HeadMotionRequest::CameraControlMode camera, Angle pan, Angle tilt, Angle speed, bool stopAndGoMode = false)
  {
...
MAKE_SKILL_IMPLEMENTATION(LookRightAndLeftImpl);
